...
const Footer = () => {
  return (
    <div className="">
      <footer className="footer p-8 ps-16 bg-black text-white">
        <nav>
          <h6 className="text-red-500 footer-title">Services</h6>
        ...
        <nav>
          <h6 className="footer-title text-red-500">Company</h6>
        ...
        <nav>
          <h6 className="footer-title text-red-500">Legal</h6>
        ...
        {/* <form>
          ...
          <fieldset className="form-control w-80">
            ...
            <div className="join">
              ...
              <button className="btn bg-red-600 join-item">Subscribe</button>
            </div>
          </fieldset>
        </form> */}
      </footer>
